const Core = {
    ...
    // --- HOME LOGIC (SUPER MIXED) ---
    loadHome: async () => {
        let flickFavs = []; // Penampung Data Favorit Flickreel
        ...
        try {
            ...
            // Simpan Fav untuk digabung ke Grid Trending
        ...
        Promise.all([
            ...
            combinedLatest.sort(() => 0.5 - Math.random()); // Acak
        ...
        // 3. TRENDING MIXED (DRAMABOX TRENDING + FLICKREEL FAVORIT)
        DramaboxV2.fetchTrending().then(dbData => {
            // Gabungkan data DB Trending dan Flickreel Favorit
            let combinedTrending = [...(dbData || []), ...flickFavs];
            
            // Acak biar isinya bervariasi
