const Core = {
    ...
    loadHome: async () => {
        ...
        // Ambil Data Netshort (Viral List)
    ...
    loadDubbed: async () => {
        ...
        // 1. Ambil dari Dramabox
        const dbData = await Dramabox.fetchDubbed(1, 50);
        
        // 2. Ambil dari Netshort (Grup Dubbing)
    ...
    openPlayer: async (source, id) => {
        ...
        if (Core.activeFetchId !== thisRequestId) { console.log("Request drama kadaluarsa."); return; }
