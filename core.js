const Core = {
    ...
    // --- HOME LOGIC (NO MELOLO) ---
    loadHome: async () => {
        // 1. Load Trending Dramabox (Slider + Grid Utama)
        try {
        ...
        // Hapus Section Melolo jika masih ada di DOM (Safety)
    ...
    playSpecificEpisode: async (index) => {
        ...
        // TIDAK ADA LAGI LOGIKA MELOLO DI SINI
    ...
    handleSearch: async () => {
        ...
        try {
            // Paralel Search: Dramabox & Netshort (No Melolo)
