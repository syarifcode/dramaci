const Melolo = {
    ...
    fetchHome: async () => {
        ...
        let latestList = (latestRes && latestRes.books) ? latestRes.books : 
                         (latestRes && latestRes.data && latestRes.data.books) ? latestRes.data.books : [];
        let trendingList = (trendingRes && trendingRes.books) ? trendingRes.books : 
                           (trendingRes && trendingRes.data && trendingRes.data.books) ? trendingRes.data.books : [];
